...
const About = () => {
    return (
        <div className="container mt-5 ">
            ...
            <p className="my-3">
                <p className="my-3">
                    <strong className='market'>Market</strong> <strong className='mate'>Mate</strong><strong> store.com</strong> makes more food products more accessible to more people than ever before.Our ecommerce website is accessible by all visitors to positively impact businesses
                    ...
                    across the country we typically deliver inthree to five business days. We can redistribute 45,000 stocked products from more than 1,000 suppliers and our special order items are
                    available as well.</p>
                <p className="my-3">
